...
def read_frame_with_sync(bit_duration, preamble_end_time):
    ...
    # Ustaw pierwszy punkt próbkowania
    sample_time = preamble_end_time + bit_duration + (bit_duration // 2)

    # Próbkuj bity ze stałą fazą
    for i in range(bits_to_read):
        # Czekaj do dokładnego środka bitu
        ...
        # Ustaw kolejny środek bitu — UWAGA: *kumulacyjnie*!
        sample_time += bit_duration
